        ...
        <main className="min-h-screen flex flex-col items-center bg-gray-50">
            ...
            <section id="tentang" className="w-full max-w-5xl px-4 mt-20 mb-20 text-center">
                ...
                <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto">
                    ...
                    untuk menyediakan data spasial terpadu, terbuka, dan mudah diakses. Platform ini
                    bertujuan mendukung transparansi, perencanaan pembangunan, dan layanan publik berbasis geospasial.
                </p>
            </section>
            ...
            <section id="kontak" className="w-full max-w-5xl px-4 mb-20 text-center">
                ...
                <p className="text-gray-700">
                    ...
                    📧 <a href="mailto:kominfo@bintunikab.go.id" className="text-blue-600 hover:underline">
